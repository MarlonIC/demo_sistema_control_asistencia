...
<head>
    ...
    <script type="text/javascript">
		...
		function evaluarSeleccion(valor){
            var obj = document.forms[0];
            switch(valor){
                case 'J':
                    document.getElementById('tr_per_nombres').style.display='none';
					document.getElementById('tr_per_apellidos_paterno').style.display='none';
					document.getElementById('tr_per_apellidos_materno').style.display='none';
					document.getElementById('tr_tid_codigo').style.display='none';
					document.getElementById('tr_per_nro_documento').style.display='none';
					document.getElementById('tr_per_razon_social').style.display='';
					document.getElementById('tr_per_nro_ruc').style.display='';
					document.getElementById('tr_ubi_codigo').style.display='none';					
					document.getElementById('tr_per_direccion_domicilio').style.display='';	
					document.getElementById('tr_per_domicilio_en_ubigeo').style.display='none';
					document.getElementById('tr_per_fecha_nacimiento').style.display='none';
					document.getElementById('tr_per_genero').style.display='none';
					document.getElementById('tr_esc_codigo').style.display='none';
					document.getElementById('tr_per_celular').style.display='none';
					document.getElementById('tr_per_telefonos').style.display='';
					document.getElementById('tr_per_nombres_conyuge').style.display='none';
					document.getElementById('tr_per_apellidos_conyuge').style.display='none';
					document.getElementById('tr_tid_codigo_conyuge').style.display='none';
					document.getElementById('tr_per_nro_documento_conyuge').style.display='none';
					document.getElementById('tr_per_carga_familiar').style.display='none';
					document.getElementById('tr_per_actividad_laboral').style.display='none';
					document.getElementById('tr_per_foto').style.display='';
					document.getElementById('tr_per_observaciones').style.display='';
					document.getElementById('td_per_razon_social').innerHTML = 'Razón Social<span class="required">*</span>';
					document.getElementById('td_per_nro_ruc').innerHTML = 'Número RUC<span class="required">*</span>';

					document.getElementById('per_nombres').value = "";
					document.getElementById('per_apellidos_paterno').value = "";
					document.getElementById('per_apellidos_materno').value = "";
					document.getElementById('tid_codigo').selectedIndex = 0;
					document.getElementById('per_nro_documento').value = "";
					document.getElementById('ubi_coddep').selectedIndex = 0;
					document.getElementById('ubi_codprov').selectedIndex = 0;
					document.getElementById('ubi_coddis').selectedIndex = 0;
					document.getElementById('per_domicilio_en_ubigeo').selectedIndex = 0;
					document.getElementById('per_fecha_nacimiento').value = "";
					document.getElementById('per_genero').selectedIndex = 0;
					document.getElementById('esc_codigo').selectedIndex = 0;
					document.getElementById('per_celular').value = "";
					document.getElementById('tid_codigo_conyuge').selectedIndex = 0;
					document.getElementById('per_carga_familiar').value = "";
                    break;
                case 'N':
                case '':
                    document.getElementById('tr_per_nombres').style.display='';
					document.getElementById('tr_per_apellidos_paterno').style.display='';
					document.getElementById('tr_per_apellidos_materno').style.display='';
					document.getElementById('tr_tid_codigo').style.display='';
					document.getElementById('tr_per_nro_documento').style.display='';
					document.getElementById('tr_per_razon_social').style.display='';
					document.getElementById('tr_per_nro_ruc').style.display='';
					document.getElementById('tr_ubi_codigo').style.display='';					
					document.getElementById('tr_per_direccion_domicilio').style.display='';	
					document.getElementById('tr_per_domicilio_en_ubigeo').style.display='';
					document.getElementById('tr_per_fecha_nacimiento').style.display='';
					document.getElementById('tr_per_genero').style.display='';
					document.getElementById('tr_esc_codigo').style.display='';
					document.getElementById('tr_per_celular').style.display='';
					document.getElementById('tr_per_telefonos').style.display='';
					document.getElementById('tr_per_nombres_conyuge').style.display='';
					document.getElementById('tr_per_apellidos_conyuge').style.display='';
					document.getElementById('tr_tid_codigo_conyuge').style.display='';
					document.getElementById('tr_per_nro_documento_conyuge').style.display='';
					document.getElementById('tr_per_carga_familiar').style.display='';
					document.getElementById('tr_per_actividad_laboral').style.display='';
					document.getElementById('tr_per_foto').style.display='';
					document.getElementById('tr_per_observaciones').style.display='';
					document.getElementById('td_per_razon_social').innerHTML = 'Razón Social';
					document.getElementById('td_per_nro_ruc').innerHTML = 'Número RUC';
					break;
            }
        }
...
<body>
<?php echo form_open('persona/editarsave', array('id'=>'Form1')); ?>
	<input id="per_codigo" type="hidden" name="per_codigo" value="<?php $d=isset($result)?$result->per_codigo:null; echo set_value('per_codigo',$d) ?>" />
	<input id="usu_codigo" type="hidden" name="usu_codigo" value="<?php $d=isset($result)?$result->usu_codigo:null; echo set_value('usu_codigo',$d) ?>" />
	<input id="h_ubi_codprov" type="hidden" name="h_ubi_codprov" />
	<input id="h_ubi_coddis" type="hidden" name="h_ubi_coddis" />
	<input id="per_listado_roles" type="hidden" name="per_listado_roles" value="<?php $d=isset($result)?$result->per_listado_roles:null; echo set_value('per_listado_roles',$d) ?>" />
	<input id="h_per_tiene_acceso" type="hidden" name="h_per_tiene_acceso" value="<?php $d=isset($result)?$result->per_tiene_acceso:null; echo set_value('h_per_tiene_acceso',$d) ?>" />
	...
	<section>
		<div id="contenido">
			<hgroup><h1>Edición de Persona</h1></hgroup>
            <br>
			...
			<table style="width:100%;" class="Formulario">
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <input id="per_apellidos" type="text" name="per_apellidos" maxlength="30" style="width:200px;" value="<?php $d=isset($result)?$result->per_apellidos:null; echo set_value('per_apellidos',$d) ?>" />
                    ...
                    <td colspan="1">
                        <input id="per_fecha_ingreso" type="text" name="per_fecha_ingreso" maxlength="30" style="width:200px;" value="<?php $d=isset($result->per_fecha_ingreso)?date('d/m/Y', strtotime($result->per_fecha_ingreso)):null; echo set_value('per_fecha_ingreso',$d) ?>" />
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <input id="per_nombres" type="text" name="per_nombres" maxlength="30" style="width:200px;" value="<?php $d=isset($result)?$result->per_nombres:null; echo set_value('per_nombres',$d) ?>" />
						<?php echo form_error('per_nombres','<div class="error">','</div>'); ?>
                    </td colspan="1">
                    <td class="etiqueta">CARGO<span class="required">*</span></td>
                    <td colspan="1">
                        <?php echo form_dropdown('car_codigo', $comboCargo, set_value('car_codigo', (isset($_POST['car_codigo'])?$_POST['car_codigo']:$result->car_codigo)),'id="car_codigo"');?>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <input id="per_direccion" type="text" name="per_direccion" maxlength="30" style="width:200px;" value="<?php $d=isset($result)?$result->per_direccion:null; echo set_value('per_direccion',$d) ?>" />
                    ...
                    <td>
                		<table style="width:100%;" cellspacing="0" cellpadding="0">
							<tr>
								<td>
									<?php echo form_dropdown('ubi_coddep', $Combo_Departamento, set_value('ubi_coddep', (isset($_POST['ubi_coddep'])?$_POST['ubi_coddep']:$result->ubi_coddep)),'id="ubi_coddep" onchange="retorna_Provincia(this.value, 0, 0)"');?>
									<br>
                ...
                <tr>
                    ...
                    <td>
                        <input id="per_fecha_nacimiento" type="text" name="per_fecha_nacimiento" maxlength="10" style="width:100px;" value="<?php $d=isset($result->per_fecha_nacimiento)?date('d/m/Y', strtotime($result->per_fecha_nacimiento)):null; echo set_value('per_fecha_nacimiento',$d) ?>" />
						<?php echo form_error('per_fecha_nacimiento','<div class="error">','</div>'); ?>
                    </td>
                    <td class="etiqueta">D.N.I<span class="required">*</span></td>
                    <td>
                        <input id="per_dni" type="text" name="per_dni" maxlength="10" style="width:100px;" value="<?php $d=isset($result)?$result->per_dni:null; echo set_value('per_dni',$d) ?>" />
						<?php echo form_error('per_dni','<div class="error">','</div>'); ?>
                    </td>
                    <td class="etiqueta">COD. DE EMP<span class="required">*</span></td>
                    <td>
                        <input id="per_codigo_empleado" type="text" name="per_codigo_empleado" maxlength="10" style="width:200px;" value="<?php $d=isset($result)?$result->per_codigo_empleado:null; echo set_value('per_codigo_empleado',$d) ?>" />
                ...
                <tr>
                    ...
                    <td>
                        <input id="per_telefono_fijo" type="text" name="per_telefono_fijo" maxlength="10" style="width:100px;" value="<?php $d=isset($result)?$result->per_telefono_fijo:null; echo set_value('per_telefono_fijo',$d) ?>" />
						<?php echo form_error('per_telefono_fijo','<div class="error">','</div>'); ?>
                    </td>
                    <td class="etiqueta">TELF. MOVIL<span class="required">*</span></td>
                    <td>
                        <input id="per_telefono_movil" type="text" name="per_telefono_movil" maxlength="30" style="width:100px;" value="<?php $d=isset($result)?$result->per_telefono_movil:null; echo set_value('per_telefono_movil',$d) ?>" />
						<?php echo form_error('per_telefono_movil','<div class="error">','</div>'); ?>
                    </td>
                    <td class="etiqueta">BANCO<span class="required">*</span></td>
                    <td>
                        <?php echo form_dropdown('ban_codigo', $comboBanco, set_value('ban_codigo', (isset($_POST['ban_codigo'])?$_POST['ban_codigo']:$result->ban_codigo)),'id="ban_codigo"');?>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <?php echo form_dropdown('seg_codigo', $comboSeguro, set_value('seg_codigo', (isset($_POST['seg_codigo'])?$_POST['seg_codigo']:$result->seg_codigo)),'id="seg_codigo"');?>
						<?php echo form_error('seg_codigo','<div class="error">','</div>'); ?>
                    </td>
                    <td class="etiqueta">CUENTA BANCO<span class="required">*</span></td>
                    <td>
                        <input id="per_cuenta_banco" type="text" name="per_cuenta_banco" maxlength="20" style="width:200px;" value="<?php $d=isset($result)?$result->per_cuenta_banco:null; echo set_value('per_cuenta_banco',$d) ?>" />
                ...
                <tr>
                    ...
                    <td  colspan="5">
                        <?php echo form_dropdown('nie_codigo', $comboNivelEstudios, set_value('nie_codigo', (isset($_POST['nie_codigo'])?$_POST['nie_codigo']:$result->nie_codigo)),'id="nie_codigo"');?>
                ...
                <tr>
                    ...
                    <td colspan="5">
                        <input id="per_lugar_estudios" type="text" name="per_lugar_estudios" maxlength="30" style="width:400px;" value="<?php $d=isset($result)?$result->per_lugar_estudios:null; echo set_value('per_lugar_estudios',$d) ?>" />
				...
				<tr>
                    ...
                    <td colspan="5">
                        <input id="per_ultrabajo_empresa" type="text" name="per_ultrabajo_empresa" maxlength="30" style="width:400px;" value="<?php $d=isset($result)?$result->per_ultrabajo_empresa:null; echo set_value('per_ultrabajo_empresa',$d) ?>" />
                ...
                <tr>
                    ...
                    <td colspan="5">
                        <input id="per_ultrabajo_cargo" type="text" name="per_ultrabajo_cargo" maxlength="30" style="width:400px;" value="<?php $d=isset($result)?$result->per_ultrabajo_cargo:null; echo set_value('per_ultrabajo_cargo',$d) ?>" />
                ...
                <tr>
                    ...
                    <td colspan="5">
                        <input id="per_ultrabajo_telefono" type="text" name="per_ultrabajo_telefono" maxlength="30" style="width:400px;" value="<?php $d=isset($result)?$result->per_ultrabajo_telefono:null; echo set_value('per_ultrabajo_telefono',$d) ?>" />
				...
				<tr>
                    ...
                    <td colspan="2">
                        <input id="refp_referencia[0]" type="text" name="refp_referencia[0]" maxlength="30" style="width:200px;" value="<?php $d=isset($result_drp[0])?$result_drp[0]->refp_referencia:null; echo set_value('refp_referencia[0]',$d) ?>" />
						<?php echo form_error('refp_referencia[0]','<div class="error">','</div>'); ?>
                    </td>
                    <td class="etiqueta">REFERENCIA(2)</td>
                    <td colspan="2">
                        <input id="refp_referencia[1]" type="text" name="refp_referencia[1]" maxlength="30" style="width:200px;" value="<?php $d=isset($result_drp[1])?$result_drp[1]->refp_referencia:null; echo set_value('refp_referencia[1]',$d) ?>" />
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <input id="refp_edad[0]" type="text" name="refp_edad[0]" maxlength="30" style="width:200px;" value="<?php $d=isset($result_drp[0])?$result_drp[0]->refp_edad:null; echo set_value('refp_edad[0]',$d) ?>" />
						<?php echo form_error('refp_edad[0]','<div class="error">','</div>'); ?>
                    </td>
                    <td class="etiqueta">EDAD</td>
                    <td colspan="2">
                        <input id="refp_edad[1]" type="text" name="refp_edad[1]" maxlength="30" style="width:200px;" value="<?php $d=isset($result_drp[1])?$result_drp[1]->refp_edad:null; echo set_value('refp_edad[1]',$d) ?>" />
                ...
                <tr>
                    <td class="etiqueta">TELEFONO</td>
                    <td colspan="2">
                        <input id="refp_telefono[0]" type="text" name="refp_telefono[0]" maxlength="30" style="width:200px;" value="<?php $d=isset($result_drp[0])?$result_drp[0]->refp_telefono:null; echo set_value('refp_telefono[0]',$d) ?>" />
						<?php echo form_error('refp_telefono[0]','<div class="error">','</div>'); ?>
                    </td>
                    <td class="etiqueta">TELEFONO</td>
                    <td colspan="2">
                        <input id="refp_telefono[1]" type="text" name="refp_telefono[1]" maxlength="30" style="width:200px;" value="<?php $d=isset($result_drp[1])?$result_drp[1]->refp_telefono:null; echo set_value('refp_telefono[1]',$d) ?>" />
				...
				<tr>
                    ...
                    <td colspan="2">
                        <?php echo form_dropdown('esc_codigo', $Combo_Estadocivil, set_value('esc_codigo', (isset($_POST['esc_codigo'])?$_POST['esc_codigo']:$result->esc_codigo)),'id="esc_codigo"');?>
						<?php echo form_error('esc_codigo','<div class="error">','</div>'); ?>
                    </td>
                    <td class="etiqueta">NUMERO DE HIJOS<span class="required">*</span></td>
                    <td colspan="2">
                        <input id="per_nro_hijos" type="number" min="0" max="10" name="per_nro_hijos" maxlength="30" style="width:100px;" value="<?php $d=isset($result)?$result->per_nro_hijos:null; echo set_value('per_nro_hijos',$d) ?>" />
				...
				<tr>
                    ...
                    <td>
                        <input id="hic_nombres[0]" type="text" name="hic_nombres[0]" maxlength="30" style="width:100px;" value="<?php $d=isset($result_dhc[0])?$result_dhc[0]->hic_nombres:null; echo set_value('hic_nombres[0]',$d) ?>" />
						<?php echo form_error('hic_nombres[0]','<div class="error">','</div>'); ?>
                    </td>
                    <td class="etiqueta">APELLIDOS</td>
                    <td>
                        <input id="hic_apellidos[0]" type="text" name="hic_apellidos[0]" maxlength="30" style="width:100px;" value="<?php $d=isset($result_dhc[0])?$result_dhc[0]->hic_apellidos:null; echo set_value('hic_apellidos[0]',$d) ?>" />
						<?php echo form_error('hic_apellidos[0]','<div class="error">','</div>'); ?>
                    </td>
                    <td class="etiqueta">EDAD</td>
                    <td>
                        <input id="hic_edad[0]" type="text" name="hic_edad[0]" maxlength="30" style="width:100px;" value="<?php $d=isset($result_dhc[0])?$result_dhc[0]->hic_edad:null; echo set_value('hic_edad[0]',$d) ?>" />
                ...
                <tr>
                    ...
                    <td>
                        <input id="hic_nombres[1]" type="text" name="hic_nombres[1]" maxlength="30" style="width:100px;" value="<?php $d=isset($result_dhc[1])?$result_dhc[1]->hic_nombres:null; echo set_value('hic_nombres[1]',$d) ?>" />
						<?php echo form_error('hic_nombres[1]','<div class="error">','</div>'); ?>
                    </td>
                    <td class="etiqueta">APELLIDOS</td>
                    <td>
                        <input id="hic_apellidos[1]" type="text" name="hic_apellidos[1]" maxlength="30" style="width:100px;" value="<?php $d=isset($result_dhc[1])?$result_dhc[1]->hic_apellidos:null; echo set_value('hic_apellidos[1]',$d) ?>" />
						<?php echo form_error('hic_apellidos[1]]','<div class="error">','</div>'); ?>
                    </td>
                    <td class="etiqueta">EDAD</td>
                    <td>
                        <input id="hic_edad[1]" type="text" name="hic_edad[1]" maxlength="30" style="width:100px;" value="<?php $d=isset($result_dhc[1])?$result_dhc[1]->hic_edad:null; echo set_value('hic_edad[1]',$d) ?>" />
                ...
                <tr>
                    ...
                    <td>
                        <input id="hic_nombres[2]" type="text" name="hic_nombres[2]" maxlength="30" style="width:100px;" value="<?php $d=isset($result_dhc[2])?$result_dhc[2]->hic_nombres:null; echo set_value('hic_nombres[2]',$d) ?>" />
						<?php echo form_error('hic_nombres[2]','<div class="error">','</div>'); ?>
                    </td>
                    <td class="etiqueta">APELLIDOS</td>
                    <td>
                        <input id="hic_apellidos[2]" type="text" name="hic_apellidos[2]" maxlength="30" style="width:100px;" value="<?php $d=isset($result_dhc[2])?$result_dhc[2]->hic_apellidos:null; echo set_value('hic_apellidos[2]',$d) ?>" />
						<?php echo form_error('hic_apellidos[2]','<div class="error">','</div>'); ?>
                    </td>
                    <td class="etiqueta">EDAD</td>
                    <td>
                        <input id="hic_edad[2]" type="text" name="hic_edad[2]" maxlength="30" style="width:100px;" value="<?php $d=isset($result_dhc[2])?$result_dhc[2]->hic_edad:null; echo set_value('hic_edad[2]',$d) ?>" />
                ...
                <tr>
                    ...
                    <td>
                        <input id="hic_nombres[3]" type="text" name="hic_nombres[3]" maxlength="30" style="width:100px;" value="<?php $d=isset($result_dhc[3])?$result_dhc[3]->hic_nombres:null; echo set_value('hic_nombres[3]',$d) ?>" />
						<?php echo form_error('hic_nombres[3]','<div class="error">','</div>'); ?>
                    </td>
                    <td class="etiqueta">APELLIDOS</td>
                    <td>
                        <input id="hic_apellidos[3]" type="text" name="hic_apellidos[3]" maxlength="30" style="width:100px;" value="<?php $d=isset($result_dhc[3])?$result_dhc[3]->hic_apellidos:null; echo set_value('hic_apellidos[3]',$d) ?>" />
						<?php echo form_error('hic_apellidos[3]','<div class="error">','</div>'); ?>
                    </td>
                    <td class="etiqueta">EDAD</td>
                    <td>
                        <input id="hic_edad[3]" type="text" name="hic_edad[3]" maxlength="30" style="width:100px;" value="<?php $d=isset($result_dhc[3])?$result_dhc[3]->hic_edad:null; echo set_value('hic_edad[3]',$d) ?>" />
				...
				<tr>
                    <td class="etiqueta">1. NOMBRES</td>
                    <td>
                        <input id="per_casoemer_nombres" type="text" name="per_casoemer_nombres" maxlength="30" style="width:100px;" value="<?php $d=isset($result)?$result->per_casoemer_nombres:null; echo set_value('per_casoemer_nombres',$d) ?>" />
						<?php echo form_error('per_casoemer_nombres','<div class="error">','</div>'); ?>
                    </td>
                    <td class="etiqueta">APELLIDOS</td>
                    <td>
                        <input id="per_casoemer_apellidos" type="text" name="per_casoemer_apellidos" maxlength="30" style="width:100px;" value="<?php $d=isset($result)?$result->per_casoemer_apellidos:null; echo set_value('per_casoemer_apellidos',$d) ?>" />
						<?php echo form_error('per_casoemer_apellidos','<div class="error">','</div>'); ?>
                    </td>
                    <td class="etiqueta">TELEFONO</td>
                    <td>
                        <input id="per_casoemer_telefono" type="text" name="per_casoemer_telefono" maxlength="30" style="width:100px;" value="<?php $d=isset($result)?$result->per_casoemer_telefono:null; echo set_value('per_casoemer_telefono',$d) ?>" />
                    </td>
                </tr>
                <tr>
				...
				<tr>
                    <td class="etiqueta">1. NOMBRES</td>
                    <td>
                        <input id="per_recomendado_nombres" type="text" name="per_recomendado_nombres" maxlength="30" style="width:100px;" value="<?php $d=isset($result)?$result->per_recomendado_nombres:null; echo set_value('per_recomendado_nombres',$d) ?>" />
						<?php echo form_error('per_recomendado_nombres','<div class="error">','</div>'); ?>
                    </td>
                    <td class="etiqueta">APELLIDOS</td>
                    <td>
                        <input id="per_recomendado_apellidos" type="text" name="per_recomendado_apellidos" maxlength="30" style="width:100px;" value="<?php $d=isset($result)?$result->per_recomendado_apellidos:null; echo set_value('per_recomendado_apellidos',$d) ?>" />
						<?php echo form_error('per_recomendado_apellidos','<div class="error">','</div>'); ?>
                    </td>
                    <td class="etiqueta">TELEFONO</td>
                    <td>
                        <input id="per_recomendado_telefono" type="text" name="per_recomendado_telefono" maxlength="30" style="width:100px;" value="<?php $d=isset($result)?$result->per_recomendado_telefono:null; echo set_value('per_recomendado_telefono',$d) ?>" />
				...
				<tr>
                    ...
                    <td colspan="5">
                        <select id="per_tiene_acceso" name="per_tiene_acceso" onchange="evaluarSeleccion2(this.value)">
                            ...
                            <option value="S" <?php echo set_select('per_tiene_acceso', 'S', (isset($result)?(setbool_radio($result->per_tiene_acceso,'S')):FALSE)); ?>>Si</option>
                            <option value="N" <?php echo set_select('per_tiene_acceso', 'N', (isset($result)?(setbool_radio($result->per_tiene_acceso,'N')):FALSE)); ?>>No</option>
                        </select>
                ...
                <tr id="tr_seleccione_3" style="DISPLAY:none">
                    <td class="etiqueta">Seleccione Roles</td>
                    <td colspan="5">
                ...
                <tr id="tr_usu_login" style="DISPLAY:none">
                    <td class="etiqueta">Login de Acceso<span class="required">*</span></td>
                    <td colspan="5">
                        <input id="usu_login" type="text" name="usu_login" maxlength="30" autocomplete="off" style="width:150px;" value="<?php $d=isset($result)?$result->usu_login:null; echo set_value('usu_login',$d) ?>" />
						<?php echo form_error('usu_login','<div class="error">','</div>'); ?>
                    </td>
                </tr>
                <tr id="tr_usu_password" style="DISPLAY:none">
                    <td class="etiqueta">Contraseña<span class="required">*</span></td>
                    <td colspan="5">
                        <input id="usu_password" type="password" name="usu_password" maxlength="30" autocomplete="off" style="width:150px;" value="<?php $d=isset($result)?$this->encrypt->decode($result->usu_password):null; echo set_value('usu_password',$d) ?>" />
				...
				<tr>
                    ...
                    <td colspan="5">
						<input name="per_estado" type="radio" id="per_estadoA" value="A" <?php echo set_radio('per_estado', 'A', (isset($result)?(setbool_radio($result->per_estado,'A')):FALSE)); ?>><label>Activo</label>
						<input name="per_estado" type="radio" id="per_estadoB" value="B" <?php echo set_radio('per_estado', 'B', (isset($result)?(setbool_radio($result->per_estado,'B')):FALSE)); ?>><label>Bloqueado</label>
...
<script>	
	...
	<?php else: ?>
		<?php if(isset($result->ubi_coddep) and isset($result->ubi_codprov)): ?>
			retorna_Provincia('<?php echo $result->ubi_coddep; ?>', '<?php echo $result->ubi_codprov; ?>', 1)
		<?php endif; ?>
	<?php endif; ?>
	<?php if(isset($_POST['h_ubi_codprov'])): ?>
	retorna_Distrito('<?php echo $_POST['h_ubi_codprov']; ?>', '<?php echo $_POST['h_ubi_coddis']; ?>', 1)
	<?php else: ?>
		<?php if(isset($result->ubi_codprov) and isset($result->ubi_coddis)): ?>
			retorna_Distrito('<?php echo $result->ubi_codprov; ?>', '<?php echo $result->ubi_coddis; ?>', 1)
		<?php endif; ?>
	<?php endif; ?>
	...
	<?php else: ?>
		//aleluyaaaa
		var per_foto = '<?php echo $result->per_foto; ?>'
		if(per_foto != ''){
			document.getElementById('div_ifile').style.display = 'none';
	        document.getElementById('div_ilist').style.display = 'block';
	        document.getElementById('div_list').innerHTML = '<a id="a_list" href="'+ base_url +'files/'+ per_foto +'" class="uviewfile" target="_blank">'+ per_foto +'</a>';
	...
	<?php else: ?>
		var per_listado_roles = obj.per_listado_roles.value;
