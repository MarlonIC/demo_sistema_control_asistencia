...
<body>
<?php echo form_open('rol/registrarsave', array('id'=>'Form1')); ?>
    <header>
		<?php echo $header; ?>
	</header>
	<nav>
	...
	<section>
		<div id="contenido">
			<hgroup><h1>Registro de Roles</h1></hgroup>
            <br>
			...
			<table style="width:100%;" class="Formulario">
                ...
                <tr>
                    ...
                    <td width="62%">
                        <input id="rol_nombre" type="text" name="rol_nombre" maxlength="30" style="width:200px;" value="<?php echo set_value('rol_nombre'); ?>" />
                ...
                <tr>
                    ...
                    <td>
                        <input id="rol_alias" type="text" name="rol_alias" maxlength="6" style="width:120px;" value="<?php echo set_value('rol_alias'); ?>" />
				...
				<tr>
                    ...
                    <td>
                        <input name="rol_estado" type="radio" id="rol_estadoA" value="A" <?php echo set_radio('rol_estado', 'A', TRUE); ?>><label>Activo</label>
						<input name="rol_estado" type="radio" id="rol_estadoB" value="B" <?php echo set_radio('rol_estado', 'B'); ?>><label>Bloqueado</label>
						<?php echo form_error('rol_estado','<div class="error">','</div>'); ?>
                    </td>
                </tr>
                <tr>
