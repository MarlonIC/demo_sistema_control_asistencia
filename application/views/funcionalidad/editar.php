...
<body>
<?php echo form_open('funcionalidad/editarsave', array('id'=>'Form1')); ?>
	<input id="fun_codigo" type="hidden" name="fun_codigo" value="<?php $d=isset($result)?$result->fun_codigo:null; echo set_value('fun_codigo',$d) ?>" />
    <header>
		<?php echo $header; ?>
	</header>
	<nav>
	...
	<section>
		<div id="contenido">
			<hgroup><h1>Edición de Funcionalidad</h1></hgroup>
            <br>
			...
			<table style="width:100%;" class="Formulario">
				...
				<tr>
                    ...
                    <td width="62%">
                        <input id="fun_nombre" type="text" name="fun_nombre" maxlength="30" style="width:200px;" value="<?php $d=isset($result)?$result->fun_nombre:null; echo set_value('fun_nombre',$d) ?>"  />
                ...
                <tr>
                    ...
                    <td>
                        <input id="fun_alias" type="text" name="fun_alias" maxlength="6" style="width:120px;" value="<?php $d=isset($result)?$result->fun_alias:null; echo set_value('fun_alias',$d) ?>" readonly />
                ...
                <tr>
                    ...
                    <td>
                        <?php echo form_dropdown('fun_codigo_padre', $Combo_Funcionalidad, set_value('fun_codigo_padre', (isset($_POST['fun_codigo_padre'])?$_POST['fun_codigo_padre']:$result->fun_codigo_padre)));?>
                ...
                <tr>
                    ...
                    <td>
                        <input id="fun_url" type="text" name="fun_url" maxlength="120" style="width:200px;" value="<?php $d=isset($result)?$result->fun_url:null; echo set_value('fun_url',$d) ?>" readonly />
                ...
                <tr>
                    ...
                    <td>
                        <input id="fun_orden" type="text" name="fun_orden" maxlength="5" style="width:120px;" value="<?php $d=isset($result)?$result->fun_orden:null; echo set_value('fun_orden',$d) ?>"  />
                ...
                <tr>
                    ...
                    <td>
                        <select id="fun_tipo" name="fun_tipo">
                            ...
                            <option value="I" <?php echo set_select('fun_tipo', 'I', (isset($result)?(setbool_radio($result->fun_tipo,'I')):FALSE)); ?>>Interno</option>
                            <option value="E" <?php echo set_select('fun_tipo', 'E', (isset($result)?(setbool_radio($result->fun_tipo,'E')):FALSE)); ?>>Externo</option>
                        </select>
                ...
                <tr>
                    ...
                    <td>
                        <input name="fun_estado" type="radio" id="fun_estadoA" value="A" <?php echo set_radio('fun_estado', 'A', (isset($result)?(setbool_radio($result->fun_estado,'A')):FALSE)); ?>><label>Activo</label>
						<input name="fun_estado" type="radio" id="fun_estadoB" value="B" <?php echo set_radio('fun_estado', 'B', (isset($result)?(setbool_radio($result->fun_estado,'B')):FALSE)); ?>><label>Bloqueado</label>
