...
<body>
<?php echo form_open('funcionalidad/detalle', array('id'=>'Form1')); ?>
    <header>
		<?php echo $header; ?>
	</header>
	<nav>
	...
	<section>
		<div id="contenido">
			<hgroup><h1>Detalle de Funcionalidad</h1></hgroup>
            <br>
			<table style="width:100%;" class="Formulario">
                ...
                <tr>
                    ...
                    <td width="62%">
                        <?php echo $result->fun_nombre; ?>
                    </td>
                </tr>
                <tr>
                    <td class="etiqueta">Alias</td>
                    <td>
                        <?php echo $result->fun_alias; ?>
                    </td>
                </tr>
                <tr>
                    <td class="etiqueta">Agrupador</td>
                    <td>
                        <?php echo $result->fun_nombre_padre; ?>
                    </td>
                </tr>
                <tr>
                    <td class="etiqueta">Dirección URL</td>
                    <td>
                        <?php echo $result->fun_url; ?>
                    </td>
                </tr>
                <tr>
                    <td class="etiqueta">Orden Vista</td>
                    <td>
                        <?php echo $result->fun_orden; ?>
                    </td>
                </tr>
                <tr>
                    <td class="etiqueta">Tipo Enlace</td>
                    <td>
                        <?php echo settext_estado5($result->fun_tipo); ?>
                    </td>
                </tr>
                <tr>
                    <td class="etiqueta">Estado</td>
                    <td>
                        <?php echo settext_estado($result->fun_estado); ?>
                    </td>
                </tr>
                <tr>
